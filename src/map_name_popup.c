...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
    ...
    [MAPSEC_TIDEVIEW_CITY - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTE_136 - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD
};
...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping_BW[] =
{
    ...
    [MAPSEC_TIDEVIEW_CITY] = MAPPOPUP_THEME_BW_DEFAULT,
};
